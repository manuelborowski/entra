...
# 1.59 - leerid - 2: implemented upload and send-via-smartschool of LeerID


@flask_app.context_processor
def inject_defaults():
    return dict(version='@ 2022 MB. V1.59 - leerid - 2', title=flask_app.config['HTML_TITLE'], site_name=flask_app.config['SITE_NAME'], testmode = flask_app.testmode)
