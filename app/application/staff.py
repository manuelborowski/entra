...
def api_staff_add(data):
    try:
        ...
        if db_staff:
            db_ok = True
            ad_ok = mad.ad_staff_process_flagged({"staff": [db_staff]})
...
def api_staff_update(data):
    try:
        ...
        if "password_data" in data:
            ...
            if db_staff:
                ad_ok = ad_ok and mad.ad_staff_process_flagged({"staff": [db_staff]})
...
def api_staff_delete(data):
    try:
        ...
        if staff_to_delete:
            ...
            mad.ad_staff_process_flagged({"staff": [staff_to_delete]})
