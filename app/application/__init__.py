...
from app.application.ad import cron_ad_student_task, cron_ad_staff_task, cron_ad_get_student_computer_task
...
cron_table = [
    ...
    ('AD-STAFF', cron_ad_staff_task, 'NAAR AD, personeel bijwerken', ''),
